...
from RC_simulator_test import RCR_sim
...
# set up simulation
cycleTime   = 1.086999999999999966
totalCycles = 30
p_no_noise  = RCR_sim([Rp, Rd, C], cycleTime, totalCycles, plot=True)
...
RCR_bounds_grid = np.array([0.5, 0.2, 0.5])
...
# sio.savemat('./grid_RCR_pressures_invaert.mat', {'Rp_mesh': Rp_mesh, 'Rd_mesh': Rd_mesh, 'C_mesh': C_mesh, 'grid_p_min': grid_p_min, 'grid_p_max': grid_p_max, 'grid_p_mean': grid_p_mean})
...
# s           = sio.loadmat('./grid_RCR_pressures_invaert.mat')
